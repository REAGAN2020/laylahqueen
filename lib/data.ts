...
const products: IProductInput[] = [
  {
    ...
    category: 'T-Shirts',
    images: ['/images/hair-1.jpg', '/images/p11-2.jpg'],
    tags: ['new-arrival'],
    isPublished: true,
    price: 21.8,
    listPrice: 0,
  ...
  },
  {
    ...
    category: 'T-Shirts',
    brand: 'Jerzees',
    images: ['/images/hair-4.jpg', '/images/p14-2.jpg'],
    tags: ['todays-deal'],
    isPublished: true,
    price: 26.95,
    listPrice: 46.03,
  ...
  settings: [
    {
      ...
      site: {
        name: 'Queenslaylah',
        description:
          'Queenslaylah is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
